 ...
 */
final class Version20201008104819 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE students ADD CONSTRAINT FK_A4698DB2CB944F1A FOREIGN KEY (student_id) REFERENCES andress (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
